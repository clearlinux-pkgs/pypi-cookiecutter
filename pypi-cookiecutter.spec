...
Source0  : https://files.pythonhosted.org/packages/52/17/9f2cd228eb949a91915acd38d3eecdc9d8893dde353b603f0db7e9f6be55/cookiecutter-2.6.0.tar.gz
...
%prep
%setup -q -n cookiecutter-2.6.0
cd %{_builddir}/cookiecutter-2.6.0
pushd ..
cp -a cookiecutter-2.6.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708615101
