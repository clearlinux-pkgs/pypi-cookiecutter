...
Source0  : https://files.pythonhosted.org/packages/eb/d4/71191a5c76da517a965517fe6d4edcc41208f758b6a7fc7df6004faf421b/cookiecutter-2.1.0.tar.gz
...
%prep
%setup -q -n cookiecutter-2.1.0
cd %{_builddir}/cookiecutter-2.1.0
pushd ..
cp -a cookiecutter-2.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1654036656
...
cp %{_builddir}/cookiecutter-2.1.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-cookiecutter/03460e483288718db7878b66bd90ab06e7346469
