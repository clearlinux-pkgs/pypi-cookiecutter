...
Source0  : https://files.pythonhosted.org/packages/2a/89/aeecd1fcbb95ced583519aebccf02451f8900f7d9b55a368e131f8110f2e/cookiecutter-2.2.0.tar.gz
...
%prep
%setup -q -n cookiecutter-2.2.0
cd %{_builddir}/cookiecutter-2.2.0
pushd ..
cp -a cookiecutter-2.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1688743615
